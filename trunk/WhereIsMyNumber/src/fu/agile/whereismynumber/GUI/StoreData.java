...
public class StoreData {
	...
	//Tao constructor khoi tao gia tri ban dau cho cac setting va thiet lap de sua vao shareperfference
	public StoreData(Context context) {
		highscoreStore = context.getSharedPreferences("highscore", context.MODE_PRIVATE);
		soundStore = context.getSharedPreferences("sound", context.MODE_PRIVATE);
